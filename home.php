...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	define('DB_PASSWORD','lzmjaK2JC2');
        ...
        if($num_rows>0){
            ...
            {
                echo "<li><p id='coins' class='navbar-text'><i class='fa fa-diamond' aria-hidden='true'>".$row['coins']."</i></p></li>";
            ...
            //echo $sql;
            echo "<li><p id='coins' class='navbar-text'><i class='fa fa-diamond' aria-hidden='true'>0</i></p></li>";
    ...
    <script type="text/javascript">  
        ...
        $(document).ready(function(){
            ...
            var socket = io.connect("skinbasar.herokuapp.com"); //change to localhost:3000
